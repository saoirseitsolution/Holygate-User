  ...
  return (
    <div className="relative h-[600px] w-full flex flex-col justify-end px-16 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-6xl mb-24">
        <div className="bg-white/95 backdrop-blur-md rounded-full p-1 flex items-center shadow-2xl">
          {/* Location Segment */}
          ...
          {/* Search Button Cap */}
          <button className="bg-[#2E2773] hover:bg-[#342da3] transition-colors text-white px-8 m-1 py-3 rounded-full flex items-center gap-3 font-bold shadow-lg shadow-indigo-200">
            <Search size={20} />
            <span>Search</span>
          </button>
