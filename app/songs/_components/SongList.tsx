...
const SongList = () => {
  ...
  return (
    ...
    <div className="py-12 container space-y-16 font-sans">
     ...
     {!wishlist && <section>
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-[#1A1C21] mb-1">Recent Songs</h2>
      ...
      <div className="mb-5">
        <h2 className="text-3xl font-bold text-[#1A1C21]">Songs</h2>
      ...
      <div className="  flex flex-col lg:flex-row items-center justify-between gap-6 mb-6">
       {!wishlist && <div className="flex  flex-wrap gap-2">
        ...
        <div className="flex items-center gap-3">
          <button onClick={()=> route.push('/songs/?wishlist=true')} className="flex cursor-pointer items-center gap-2 bg-white border border-[#2E2773]  shadow-lg px-5 py-1.5 rounded-full text-[13px] font-bold text-[#2E2773] hover:bg-indigo-50">
         ...
         { !wishlist ? <div className="relative group" onMouseEnter={(e) => e.currentTarget.classList.add('show')} onMouseLeave={(e) => e.currentTarget.classList.remove('show')}>
           ...
           <button onClick={()=> route.push('/songs')} className="flex cursor-pointer items-center gap-2 bg-white border border-[#2E2773]  shadow-lg px-5 py-1.5 rounded-full text-[13px] font-bold text-[#2E2773] hover:bg-indigo-50">
            Add More
          </button>}
        </div>
      </div>
